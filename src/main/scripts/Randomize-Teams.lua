local teams =
{
	team1 =
	{
		pokemon1 =
		{
			...
			pokemonDefense2 = 0x69,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0x78,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0x81,
			move1Code = 0x73,
			move1Pp = 0x14,
			move2Code = 0x7E,
			move2Pp = 0x5,
		...
		pokemon3 =
		{
			...
			pokemonAttack2 = 0x8e,
			pokemonDefense1 = 0x00,
			pokemonDefense2 = 0x88,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0xac,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0xc1,
			move1Code = 0x22,
			move1Pp = 0xf,
			move2Code = 0x47,
			move2Pp = 0x14,
	...
	team2 =
	{
		...
		pokemon3 =
		{
			...
			pokemonAttack2 = 0x86,
			pokemonDefense1 = 0x00,
			pokemonDefense2 = 0x7f,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0x63,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0xa7,
			move1Code = 0x6C,
			move1Pp = 0x14,
			move2Code = 0x01,
			move2Pp = 0x23,
