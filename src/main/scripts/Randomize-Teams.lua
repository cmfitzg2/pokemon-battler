local teams =
{
	team1 =
	{
		pokemon1 =
		{
			...
			pokemonDefense2 = 0x6b,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0x64,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0x91,
			move1Code = 0x5F,
			move1Pp = 0x14,
			move2Code = 0x22,
			move2Pp = 0xf,
		...
		pokemon2 =
		{
			...
			pokemonAttack2 = 0x88,
			pokemonDefense1 = 0x00,
			pokemonDefense2 = 0x89,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0xa4,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0xbf,
			move1Code = 0x32,
			move1Pp = 0x14,
			move2Code = 0x3B,
			move2Pp = 0x5,
		...
		pokemon3 =
		{
			...
			pokemonAttack2 = 0x4d,
			pokemonDefense1 = 0x00,
			pokemonDefense2 = 0x72,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0x5d,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0x85,
			move1Code = 0x6B,
			move1Pp = 0x14,
			move2Code = 0x40,
			move2Pp = 0x23,
	...
	team2 =
	{
		pokemon1 =
		{
			...
			pokemonAttack2 = 0x92,
			pokemonDefense1 = 0x00,
			pokemonDefense2 = 0x77,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0x7b,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0x6b,
			move1Code = 0x11,
			move1Pp = 0x23,
			move2Code = 0x49,
			move2Pp = 0xa,
		...
		pokemon2 =
		{
			...
			pokemonAttack2 = 0x95,
			pokemonDefense1 = 0x00,
			pokemonDefense2 = 0x6a,
			pokemonSpeed1 = 0x00,
			pokemonSpeed2 = 0x64,
			pokemonSpecial1 = 0x00,
			pokemonSpecial2 = 0x67,
			move1Code = 0x32,
			move1Pp = 0x14,
			move2Code = 0x68,
			move2Pp = 0xf,
